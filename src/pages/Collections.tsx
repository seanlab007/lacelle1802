...
const collections = [
  {
    ...
    products: [
      { name: 'Minuit Absolu', cn: '绝对午夜', concentration: 'Extrait de Parfum', volume: '50ml', price: '¥2,880' },
      { name: 'Nuit de Lumière', cn: '光之夜', concentration: 'Eau de Parfum', volume: '100ml', price: '¥1,680' },
      { name: 'Brume de Minuit', cn: '午夜薄雾', concentration: 'Eau de Toilette', volume: '100ml', price: '¥980' },
    ],
  },
  {
    id: 'amour',
    name: "Parfum d'Amour",
    cn: '爱情香水',
    subtitle: 'Collection Romantique',
    year: '1802',
    logo: `${CDN}/logo-amour_4a06a372.png`,
    img: `${CDN}/bottle-crystal_911dd6ad.jpg`,
    bg: `${CDN}/grasse-lavender_2a55b173.jpg`,
    desc: `La collection originale de la Maison, créée par Léa Celle elle-même en 1802. "Parfum d'Amour" est une déclaration d'amour à la féminité française — douce, complexe, inoubliable. Joséphine de Beauharnais en était si éprise qu'elle en fit asperger les murs de sa chambre à coucher à Malmaison.`,
    cn_desc: '品牌的原创系列，由蕾雅·奢利本人于1802年创作。"爱情香水"是对法式女性气质的情书——温柔、复杂、难以忘怀。约瑟芬·波拿巴对其如此痴迷，以至于让人将其喷洒在马尔迈松宫卧室的墙壁上。',
    notes: {
    ...
    products: [
      { name: "L'Amour Éternel", cn: '永恒之爱', concentration: 'Extrait de Parfum', volume: '30ml', price: '¥3,280' },
      { name: 'Rose de Joséphine', cn: '约瑟芬玫瑰', concentration: 'Eau de Parfum', volume: '75ml', price: '¥1,980' },
      { name: 'Fleur d\'Amour', cn: '爱情之花', concentration: 'Eau de Toilette', volume: '100ml', price: '¥1,080' },
    ],
  },
  {
    id: 'auto',
    name: "Parfum d'Auto",
    cn: '汽车香氛',
    subtitle: 'Collection Automobile',
    year: '1924',
    logo: `${CDN}/logo-auto_7518be31.png`,
    img: `${CDN}/bottle-antique-gold_d9766218.jpg`,
    bg: `${CDN}/palais-royal_e340be0a.jpg`,
    desc: `Née en 1924 à l'âge d'or de l'automobile, "Parfum d'Auto" est une collection unique au monde : des fragrances spécialement conçues pour sublimer l'intérieur des véhicules de luxe. Créée à la demande de Louis Vuitton pour les voitures de la famille royale britannique, cette collection allie la puissance des notes boisées à la délicatesse des essences florales.`,
    cn_desc: '诞生于1924年汽车黄金时代，"汽车香氛"是世界上独一无二的系列：专为提升豪华车内部空间而设计的香水。应路易威登为英国王室车辆的委托而创作，这个系列将木质调的力量与花香精华的细腻完美结合。',
    notes: {
    ...
    products: [
      { name: 'Grand Tourisme', cn: '大旅行', concentration: 'Parfum de Voiture', volume: '100ml', price: '¥1,280' },
      { name: 'Route Royale', cn: '皇家之路', concentration: 'Parfum de Voiture Premium', volume: '200ml', price: '¥2,480' },
      { name: 'Vitesse & Élégance', cn: '速度与优雅', concentration: 'Diffuseur de Luxe', volume: '50ml', price: '¥880' },
    ],
  },
]
    ...
    <div className="bg-lacelle-black pt-20">
      ...
      <section className="relative h-[50vh] min-h-[350px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          <p className="section-label mb-6">Nos Parfums · 我们的香水</p>
          ...
          <p className="font-cormorant text-xl text-lacelle-cream/70 italic mt-6">
            L'art de la fragrance depuis 1802 · 自1802年以来的香水艺术
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-0">
            {collections.map((col, i) => (
              ...
              >
                ...
                <p className="font-sans-light text-xs tracking-widest-xl text-lacelle-gold/50 uppercase mt-1">{col.cn}</p>
              </button>
            ))}
          </div>
        </div>
      ...
      {collections.map((col, i) => (
        <div key={i} className={activeCollection === i ? 'block' : 'hidden'}>
          ...
          <section className="relative py-32 overflow-hidden">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                  <p className="section-label mb-4">{col.subtitle} · Depuis {col.year}</p>
                  <img
                    src={col.logo}
                    alt={col.name}
                  ...
                  <p className="font-cormorant text-lg text-lacelle-cream/70 leading-relaxed mt-6 mb-4">
                    {col.desc}
                  </p>
          ...
          <section className="py-24 px-6 bg-lacelle-dark">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                <p className="section-label mb-4">Pyramide Olfactive · 香调金字塔</p>
                <h3 className="font-playfair text-3xl text-lacelle-cream italic">La Structure du Parfum</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  { label: 'Notes de Tête', cn: '前调', notes: col.notes.top, delay: '0s' },
                  { label: 'Notes de Cœur', cn: '中调', notes: col.notes.heart, delay: '0.1s' },
                  { label: 'Notes de Fond', cn: '后调', notes: col.notes.base, delay: '0.2s' },
                ].map((tier, j) => (
                  <div key={j} className="text-center border border-lacelle-gold/10 p-8">
                    ...
                    <p className="font-sans-light text-xs tracking-widest-xl text-lacelle-gold uppercase mb-1">{tier.label}</p>
                    <p className="font-sans-light text-xs text-lacelle-gold/50 tracking-wider mb-6">{tier.cn}</p>
                    <ul className="space-y-2">
                      {tier.notes.map((note, k) => (
          ...
          <section className="py-24 px-6">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-16">
                <p className="section-label mb-4">La Gamme · 产品系列</p>
                <h3 className="font-playfair text-3xl text-lacelle-cream italic">Nos Créations</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {col.products.map((product, j) => (
                  <div key={j} className="border border-lacelle-gold/10 p-8 hover:border-lacelle-gold/40 transition-colors duration-300">
                    ...
                    <p className="font-sans-light text-xs text-lacelle-cream/40 tracking-wider mb-4">{product.cn} · {product.volume}</p>
                    <div className="flex items-center justify-between">
                      <p className="font-cormorant text-2xl text-lacelle-gold">{product.price}</p>
                      <button className="btn-gold text-xs py-2 px-4">Enquête</button>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className="py-24 px-6 bg-lacelle-dark">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 fade-in-section">
            <p className="section-label mb-4">Toutes les Collections · 全部系列</p>
            <h2 className="font-playfair text-4xl text-lacelle-cream italic">L'Univers LA CELLE</h2>
          </div>
              ...
              >
                <div className="aspect-[3/4] relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8">
                    <p className="font-sans-light text-xs text-lacelle-gold tracking-widest-xl uppercase mb-2">{col.subtitle}</p>
                    <h3 className="font-playfair text-2xl text-lacelle-cream italic mb-1">{col.name}</h3>
                    <p className="font-sans-light text-xs text-lacelle-cream/50 tracking-wider">{col.cn} · {col.year}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-24 px-6 text-center fade-in-section">
        <p className="section-label mb-6">Collection Suprême · 至高系列</p>
        <h2 className="font-playfair text-4xl text-lacelle-cream italic mb-6">
          Découvrez Maison de Celle
        </h2>
