...
L'Impératrice, connue pour sa passion obsessionnelle des parfums — elle consommait jusqu'à 60 flacons par mois — avait une prédilection particulière pour "La Violette de Malmaison", une création exclusive de Léa Celle inspirée des jardins de la résidence impériale.`,
    zh_content: '经过五年对皇室的忠诚服务，约瑟芬皇后于1807年6月12日亲笔签署特许状，授予蕾雅·奢利"皇后陛下御用调香师"称号。这份特许状允许LA CELLE在香水瓶和包装上使用皇室徽章。约瑟芬皇后对香水有着近乎痴迷的热爱——每月使用多达60瓶——她尤其钟爱蕾雅专为马尔迈松宫花园创作的"马尔迈松紫罗兰"。',
...
Cette capacité d'adaptation, transmise de génération en génération, deviendra l'une des marques distinctives de la maison : survivre aux révolutions, aux guerres et aux changements de régime en restant fidèle à l'art du parfum.`,
    zh_content: '拿破仑倒台、波旁王朝复辟后，LA CELLE经历了艰难时期。但蕾雅·奢利拒绝关闭，她调整创作以适应新政权的品味，创作了献给路易十八的"百合之花"，从而赢得了新王室的庇护。这种适应能力代代相传，成为品牌的标志：在革命、战争和政权更迭中存活，始终忠于调香艺术。',
  ...
  },
  {
    ...
    zh_title: '第二代传承',
    fr_content: `Armand Celle, fils de Léa, prend la direction de la maison en 1848, année de révolutions en Europe. Formé à l'École de Chimie de Paris et aux côtés des grands parfumeurs de son époque, il introduit les premières synthèses chimiques dans les créations de la maison tout en préservant l'essence naturelle grassoise.
...
C'est Armand qui établit la relation durable avec la Maison Rallet, fondée en 1843 à Moscou, fournissant des essences précieuses à la cour impériale russe. Cette connexion avec la Russie des Romanov apportera à LA CELLE une renommée internationale.`,
    zh_content: '阿尔芒·奢利于1848年欧洲革命之年接掌家族事业。他在巴黎化学学院受训，并向当时的调香大师学习，将首批化学合成技术引入品牌创作，同时保留了格拉斯天然香精的精髓。正是阿尔芒建立了与1843年创立于莫斯科的拉莱特香水公司的长期合作，向俄罗斯罗曼诺夫皇室供应珍贵香精，为LA CELLE赢得了国际声誉。',
  ...
  {
    year: '1889',
    fr_title: "L'Exposition Universelle de Paris",
    zh_title: '巴黎世博会金奖',
    fr_content: `À l'Exposition Universelle de Paris de 1889 — celle qui vit naître la Tour Eiffel — la Maison LA CELLE présente "L'Essence de Grasse Absolue", une fragrance révolutionnaire concentrée à 90% en essences naturelles, une concentration jamais atteinte auparavant.
...
Le jury, présidé par Édouard Manet, décerne à LA CELLE la Médaille d'Or de la Parfumerie. Victor Hugo, présent à la cérémonie, aurait déclaré dans son discours : "Ce parfum, c'est la France elle-même — sa lumière, ses fleurs, son âme immortelle."`,
    zh_content: '在1889年巴黎世博会——埃菲尔铁塔诞生的那届——LA CELLE展示了革命性的"格拉斯绝对精华"，天然香精浓度高达90%，前所未有。由爱德华·马奈主持的评审团授予LA CELLE调香金奖。据说维克多·雨果在颁奖典礼上发表演讲时说："这款香水，就是法国本身——她的光芒、她的花朵、她不朽的灵魂。"',
...
La maison collabore avec le verrier René Lalique pour créer des flacons d'exception. Ces flacons, ornés de motifs floraux et de femmes ailées, sont aujourd'hui des pièces de collection prisées dans les plus grandes maisons de vente aux enchères mondiales.`,
    zh_content: '世纪之交，LA CELLE成为新艺术运动香水界的标杆。马塞尔·普鲁斯特在给母亲的信中写道："LA CELLE的气味让我想起了逝去的时光，贡布雷的椴树，我童年的早晨。"品牌与玻璃艺术家勒内·拉利克合作创作精美香水瓶，这些饰有花卉图案和有翼女性的香水瓶，如今是世界顶级拍卖行的珍贵藏品。',
  ...
  {
    year: '1944',
    fr_title: 'La Résistance Française',
    zh_title: '法国抵抗运动',
    fr_content: `Pendant la Seconde Guerre mondiale, la Maison LA CELLE fait face à sa plus grande épreuve. Hélène Celle, arrière-petite-fille de la fondatrice, refuse de collaborer avec l'occupant allemand qui réquisitionne les parfumeries parisiennes. Elle transfère secrètement les archives olfactives et les formules ancestrales à l'atelier de Grasse, les cachant dans les caves de la propriété familiale.
...
Cette résistance courageuse vaut à la maison, après la Libération, la Médaille de la Résistance Française et la reconnaissance du général de Gaulle, qui commande personnellement un parfum pour offrir à son épouse Yvonne.`,
    zh_content: '二战期间，LA CELLE面临最大的考验。创始人的曾曾孙女海伦·奢利拒绝与占领者合作，秘密将嗅觉档案和祖传配方转移到格拉斯工坊，藏于家族庄园的地窖中。这种英勇的抵抗为品牌赢得了解放后的法国抵抗勋章，戴高乐将军亲自订购了一款香水作为礼物送给妻子伊冯娜。',
...
L'événement est célébré au Château de Versailles en présence du Président de la République et des représentants des plus grandes maisons de parfumerie mondiales. Le journal Le Monde titre : "LA CELLE, deux siècles de nez français — une institution nationale."`,
    zh_content: '2002年品牌两百周年之际，LA CELLE推出"1802档案"系列，根据蕾雅·奢利的原始笔记重新调制七款香水，每款限量200瓶，装于忠实复制1802年原版的香水瓶中。庆典在凡尔赛宫举行，法国总统及世界顶级香水品牌代表出席。《世界报》标题写道："LA CELLE，两个世纪的法国鼻子——一个国家机构。"',
    ...
    <div className="bg-lacelle-black pt-20">
            ...
            >
              ...
              <div className={`relative overflow-hidden ${i % 2 !== 0 ? 'lg:order-2' : ''}`}>
                <div className="aspect-[4/3] lg:aspect-auto lg:h-[400px] relative">
                  <img
                    src={item.img}
                    alt={isCN ? item.zh_title : item.fr_title}
              ...
              <div className={`bg-lacelle-dark p-10 lg:p-16 flex flex-col justify-center ${i % 2 !== 0 ? 'lg:order-1' : ''}`}>
                ...
                <h3 className="font-playfair text-2xl text-lacelle-cream italic mb-6">
      ...
      <section className="py-24 px-6 text-center fade-in-section">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link to="/olfactory-notes" className="btn-gold-filled">
