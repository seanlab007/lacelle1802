...
C'est en 1802 que Léa Celle codifie la "Méthode d'Extraction LA CELLE" — un procédé révolutionnaire combinant l'enfleurage à froid grassois, la distillation à la vapeur et l'extraction par solvants naturels, permettant d'atteindre une concentration en essences naturelles de 90%, sans précédent dans l'histoire de la parfumerie mondiale. La Maison ne s'établira à Paris qu'en 1807, lorsque l'Impératrice Joséphine lui accordera son brevet impérial.`,
    ...
    bottles: [
      ...
      {
        img: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663405311158/zaTDeSlWOTIuKJrb.png',
        label_fr: 'Flacon LA CELLE · Eau de Parfum · Grasse',
        label_zh: 'LA CELLE · 香水瓶 · 格拉斯',
        desc_fr: 'Cristal gravé à décor floral, bouchon doré aux armoiries impériales, LA CELLE EAU DE PARFUM GRASSE',
        desc_zh: '花卉纹水晶瓶，镀金帝国纹章瓶塞，LA CELLE EAU DE PARFUM GRASSE',
      },
      {
        img: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663405311158/bFtzRdFRHvACUSjG.png',
        label_fr: 'Flacon Couronne Impériale — Cachet de cire',
        label_zh: '帝国皇冠瓶 — 蜡封徽章',
        desc_fr: 'Cristal taillé, bouchon couronne impériale en bronze doré avec abeille napoléonienne, cachet de cire aux armoiries',
        desc_zh: '切割水晶瓶，镀金青铜帝国皇冠瓶塞饰拿破仑蜜蜂，蜡封纹章',
      },
      {
        img: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663405311158/jQbuNgGLRMAWBUME.png',
        ...
        desc_zh: '古绿玻璃瓶，手写标签：奢利家族 · 格拉斯工坊 · 大花茉莉精华 · 1802年采收',
      },
      {
        img: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663405311158/eeXTIOLQUyuNcEZr.png',
        label_fr: 'Jasmin Grandiflorum · Cueilli à l\'aube · Distillation par enfleurage',
        label_zh: '大花茉莉 · 黎明采摘 · 冷浸蒸馏',
        desc_fr: 'Flacon vert Grasse, étiquette parchemin: Jasmin grandiflorum · Cueillie à l\'aube · Grasse, Provence · Distillation par enfleurage',
        desc_zh: '格拉斯绿瓶，羊皮纸标签：大花茉莉 · 黎明采摘 · 普罗旺斯格拉斯 · 冷浸蒸馏法',
      },
      {
        img: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663405311158/CvgNTHKhhODikqLO.png',
        label_fr: 'LA CELLE PARFUM · Distillé à Grasse · Maison fondée en 1802',
        label_zh: 'LA CELLE PARFUM · 格拉斯蒸馏 · 创立于1802年',
        desc_fr: 'Flacon sphérique en verre soufflé, bouchon filigrane doré, étiquette gravure: Distillé à Grasse · Maison fondée en 1802 · LA CELLE PARFUM',
        desc_zh: '吹制球形玻璃瓶，镀金镂空瓶塞，版画标签：格拉斯蒸馏 · 创立于1802年 · LA CELLE PARFUM',
      },
    ],
    gallery: [
      {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-lacelle-dark/50 border border-lacelle-gold/20 p-6 hover:border-lacelle-gold/60 transition-all duration-500">
                <div className="aspect-[3/4] overflow-hidden mb-4">
                  <img loading="lazy" src={`${MCDN}/AGGfAnnhfrVGwSTg.jpg`} alt="Li Hongzhang Europe mission - Louvre Archives" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <div className="border-t border-lacelle-gold/20 pt-4">
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
              ...
              {/* 先施化妆品行 */}
              <div className="bg-lacelle-dark/50 border border-lacelle-gold/20 p-6 hover:border-lacelle-gold/60 transition-all duration-500">
                <div className="aspect-[1/1] overflow-hidden mb-4 bg-black">
                  <img loading="lazy" src={`https://files.manuscdn.com/user_upload_by_module/session_file/310519663405311158/eDSJdppeQxiIrCiv.png`} alt="Sincere Co cosmetics Shanghai LA CELLE" className="w-full h-full object-contain hover:scale-105 transition-transform duration-700" />
                </div>
                <div className="border-t border-lacelle-gold/20 pt-4">
