...
const journals = [
  {
    ...
    title: 'Carnet No. 1 — Premier Jour',
    cn_title: '第一册 — 开业第一天',
    entry: `Aujourd'hui, j'ai ouvert ma boutique au Palais-Royal. Le printemps commence à peine, et les premières roses de Grasse n'arriveront que dans six semaines. J'ai disposé en vitrine mes flacons d'essences — la rose absolue, le jasmin grandiflorum, la tubéreuse — et j'ai attendu.
...
Ce soir, j'ai noté dans ce carnet la formule de ce qui deviendra ma première création officielle : "Essence de Grasse No. 1". Rose centifolia (40%), jasmin grandiflorum (25%), néroli (15%), musc blanc (10%), ambre gris (10%).`,
  ...
  },
  {
    ...
    cn_date: '1807年6月12日',
    author: 'Léa Céleste Celle',
    title: 'Carnet No. 8 — Le Brevet Impérial',
    cn_title: '第八册 — 皇室御用认证',
    entry: `Sa Majesté l'Impératrice m'a convoquée à Malmaison ce matin. J'ai traversé les jardins en fleurs — les roses qu'elle fait cultiver en son honneur, les centifolia, les damascena, les gallica — et j'ai compris pourquoi elle aime tant les parfums : elle est elle-même une fleur, complexe, éphémère, d'une beauté qui fait mal.
...
Ce soir, j'ai créé "La Violette de Malmaison" — un hommage à ses jardins : violette de Parme (30%), rose centifolia (25%), iris de Florence (20%), musc blanc (15%), civette (10%).`,
  ...
  },
  {
    ...
    title: 'Carnet No. 34 — L\'Exposition Universelle',
    cn_title: '第三十四册 — 世博会',
    entry: `Nous avons remporté la Médaille d'Or. Je n'arrive pas encore à y croire.
...
Formule de l'Essence de Grasse Absolue : Rose de Mai (35%), Jasmin Grandiflorum (30%), Tubéreuse (20%), Néroli de Bigarade (10%), Absolu de Muguet (5%).`,
  ...
  },
  {
    ...
    title: 'Carnet No. 47 — Monsieur Proust',
    cn_title: '第四十七册 — 普鲁斯特先生',
    entry: `Monsieur Marcel Proust est venu à l'atelier aujourd'hui. Il est arrivé à onze heures du soir — il ne sort jamais avant la nuit tombée, à cause de son asthme — enveloppé dans un manteau de fourrure malgré la chaleur d'août.
...
Il a tenu le flacon contre sa poitrine et a murmuré : "Voilà. C'est exactement ça. Le temps retrouvé."`,
  ...
  },
  {
    ...
    title: 'Carnet No. 89 — La Libération',
    cn_title: '第八十九册 — 解放',
    entry: `La guerre est finie. Paris est libre. La France est libre.
...
Le Général a dit, en recevant le flacon : "Madame Celle, la France vous remercie."`,
    cn_entry: '战争结束了。巴黎自由了。法国自由了。\n\n五年来，我将我们的档案藏在格拉斯工坊的地窖里。一百四十三本笔记本，数千个配方，两个世纪的技艺。德国人征用了我们在皇家宫殿的店铺，但他们从未找到最重要的东西。\n\n今天早上，戴高乐将军在香榭丽舍大道检阅了部队。下午，他的一名参谋联系了我："将军希望为庆祝解放送给戴高乐夫人一款香水。他听说了您的抵抗。他信任您。"\n\n我当晚就创作了"解放"：普罗旺斯薰衣草(30%)、绿橡木(20%)、五月玫瑰(20%)、木烟(15%)、法国湿土(15%)。一款闻起来像重获自由、普罗旺斯、胜利的香水。\n\n将军接过香水瓶时说："奢利女士，法国感谢您。"',
    img: `${CDN}/grasse-lavender_2a55b173.jpg`,
  },
]

const ingredients = [
  { name: 'Rose de Mai', cn: '五月玫瑰', origin: 'Grasse, France', desc: 'La reine des essences grassoises. Cueillie à la main pendant trois semaines en mai, elle produit une huile d\'une complexité inégalée — miel, litchi, poivre, poudre. 1 tonne de pétales pour 300g d\'absolue.', price: '€6,000/kg' },
  { name: 'Jasmin Grandiflorum', cn: '大花茉莉', origin: 'Grasse, France', desc: 'Cueilli avant l\'aube pour préserver ses molécules volatiles. Son absolue est l\'une des plus chères au monde — indolique, animale, envoûtante. La signature olfactive de la parfumerie française.', price: '€5,000/kg' },
  { name: 'Oud de Laos', cn: '老挝沉香', origin: 'Laos', desc: 'L\'or liquide de la parfumerie orientale. La résine d\'Aquilaria malaccensis infectée par un champignon particulier. Chaque arbre produit une essence unique, impossible à reproduire.', price: '€30,000/kg' },
  { name: 'Ambre Gris', cn: '龙涎香', origin: 'Océan Indien', desc: 'Sécrété par le cachalot, flotté pendant des années sur les océans avant d\'être recueilli. Son odeur — marine, boisée, animale, solaire — est l\'un des grands mystères de la parfumerie.', price: '€10,000/kg' },
  { name: 'Iris de Florence', cn: '佛罗伦萨鸢尾', origin: 'Florence, Italie', desc: 'Le rhizome d\'iris doit sécher trois ans avant d\'être distillé. Son beurre d\'iris — poudré, carotte, violette — est l\'une des essences les plus rares et les plus chères au monde.', price: '€50,000/kg' },
  { name: 'Musc de Civette', cn: '灵猫香', origin: 'Éthiopie', desc: 'Utilisé depuis l\'Antiquité, le musc de civette est un fixateur incomparable qui prolonge la durée d\'un parfum de plusieurs heures. LA CELLE utilise uniquement des sources éthiques et durables.', price: '€3,000/kg' },
]
    ...
    <div className="bg-lacelle-black pt-20">
      ...
      <section className="relative h-[55vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          <p className="section-label mb-6">Les Archives Olfactives · 嗅觉档案</p>
          ...
          <p className="font-cormorant text-xl text-lacelle-cream/70 italic mt-6">
            Les carnets secrets des maîtres parfumeurs · 调香大师的秘密笔记
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center fade-in-section">
          <p className="font-cormorant text-xl text-lacelle-cream/80 italic leading-relaxed mb-6">
            Depuis 1802, les maîtres parfumeurs de la Maison LA CELLE consignent chaque création, 
            chaque rencontre, chaque inspiration dans des carnets reliés en cuir marocain. 
            Ces 143 carnets, jalousement gardés dans les caves de l'atelier grassois, 
            constituent le patrimoine olfactif le plus précieux de la maison.
          </p>
          <p className="font-sans-light text-sm text-lacelle-gold/60 tracking-wider">
            自1802年起，LA CELLE的调香大师们将每一个创作、每一次相遇、每一份灵感
            记录在摩洛哥皮革装订的笔记本中。这143本笔记本珍藏于格拉斯工坊的地窖中，
            构成了品牌最珍贵的嗅觉遗产。
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-6 bg-lacelle-dark">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 fade-in-section">
            <p className="section-label mb-4">Extraits des Carnets · 笔记摘录</p>
            <h2 className="font-playfair text-4xl text-lacelle-cream italic">Les Carnets Secrets</h2>
          </div>
            ...
            {journals.map((j, i) => (
              <button
                ...
                className={`flex-shrink-0 px-6 py-4 text-left border-b-2 transition-all duration-300 min-w-[200px] ${
                  activeJournal === i
                    ? 'border-lacelle-gold bg-lacelle-black/50'
                    : 'border-transparent hover:border-lacelle-gold/30'
                }`}
              >
                <p className="font-sans-light text-xs text-lacelle-gold/60 tracking-wider uppercase">{j.date}</p>
                <p className="font-playfair text-sm text-lacelle-cream italic mt-1 line-clamp-2">{j.title}</p>
              </button>
            ))}
          </div>
            ...
            <div key={i} className={activeJournal === i ? 'block' : 'hidden'}>
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-0">
                ...
                <div className="lg:col-span-3 bg-lacelle-black p-10 lg:p-16">
                  <div className="mb-8">
                    <p className="font-sans-light text-xs text-lacelle-gold tracking-widest-xl uppercase mb-2">{j.date} · {j.cn_date}</p>
                    <h3 className="font-playfair text-2xl text-lacelle-cream italic mb-1">{j.title}</h3>
                    <p className="font-sans-light text-xs text-lacelle-cream/40 tracking-wider">{j.cn_title}</p>
                  ...
                  <div className="mt-10 pt-8 border-t border-lacelle-gold/10">
                    <p className="font-sans-light text-xs text-lacelle-gold/40 tracking-wider uppercase mb-4">Traduction · 译文</p>
                    <div className="font-sans-light text-lacelle-cream/30 text-xs leading-relaxed space-y-3">
                      {j.cn_entry.split('\n\n').map((para, k) => (
                        <p key={k}>{para}</p>
                      ))}
                    </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 fade-in-section">
            <p className="section-label mb-4">Les Matières Premières · 珍贵原料</p>
            <h2 className="font-playfair text-4xl text-lacelle-cream italic">
              Les Essences Rares<br />
              <span className="text-lacelle-gold">de la Maison Celle</span>
            </h2>
            ...
            {ingredients.map((ing, i) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="font-playfair text-xl text-lacelle-cream italic">{ing.name}</h3>
                    <p className="font-sans-light text-xs text-lacelle-gold/60 tracking-wider uppercase mt-1">{ing.cn}</p>
                  </div>
                  <span className="font-sans-light text-xs text-lacelle-gold/40 tracking-wider whitespace-nowrap ml-4">{ing.price}</span>
                </div>
                <p className="font-sans-light text-xs text-lacelle-cream/30 tracking-wider uppercase mb-3">{ing.origin}</p>
                <div className="w-8 h-px bg-lacelle-gold/30 mb-4" />
                <p className="font-cormorant text-lacelle-cream/60 text-sm leading-relaxed">{ing.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center fade-in-section">
          <p className="section-label mb-6">Le Nez de la Maison · 品牌调香师</p>
          <h2 className="font-playfair text-4xl md:text-5xl text-lacelle-cream italic mb-8">
            L'Art du Grand Parfumeur
          </h2>
          <div className="gold-divider" />
          <p className="font-cormorant text-xl text-lacelle-cream/70 italic leading-relaxed mt-8 mb-6">
            Le maître parfumeur de LA CELLE est formé pendant dix ans minimum avant de 
            toucher aux essences de la collection Maison de Celle. Il doit mémoriser 
            plus de 3,000 essences naturelles et synthétiques, et posséder la capacité 
            rare de composer mentalement des accords complexes sans avoir recours 
            aux instruments de mesure.
          </p>
          <p className="font-sans-light text-sm text-lacelle-gold/60 tracking-wider">
            LA CELLE的调香大师在接触Maison de Celle系列香精之前，至少需要接受十年的培训。
            他必须记住3000多种天然和合成香精，并具备无需测量仪器即可在脑中构建复杂香调的罕见能力。
          </p>
        </div>
      </section>
    </div>
